...
export const BENGS_HUBS = [
  {
    ...
    shortName: 'Найближчий кар\'єр / перевалка',
    lat: 48.5135,
    lng: 35.0850,
    isAuto: true
  },
  {
    id: 'journalists',
    name: '🏢 Головна перевалка (м. Дніпро, вул. Журналістів, 3)',
    shortName: 'вул. Журналістів, 3 (Лівий берег)',
    lat: 48.5135,
    lng: 35.0850,
    address: 'м. Дніпро, вул. Журналістів, 3'
  },
  {
    id: 'liubymivka',
    ...
    lat: 48.3750,
    lng: 35.1850,
    address: 'с. Любимівка (біля Дніпра)'
  },
  {
    id: 'naberezhna',
    name: '🏗️ Термінал «Набережна Заводська»',
    shortName: 'Набережна Заводська',
    lat: 48.4890,
    lng: 34.9850,
    address: 'м. Дніпро, вул. Набережна Заводська'
  },
  {
    id: 'kamianske',
