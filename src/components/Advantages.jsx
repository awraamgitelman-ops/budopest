    ...
    <section id="advantages" className="section advantages-section">
      <div className="container">
        <div className="section-header text-center">
          ...
          <h2 className="section-title">Чому обирають компанію «РУД МОНОЛІТ» у Дніпрі</h2>
          <p className="section-subtitle mx-auto">
            «РУД МОНОЛІТ» (ТОВ «БЕНГС») забезпечує безперебійне постачання нерудних будівельних матеріалів для будівельних компаній, виробників бетону, дорожніх служб та приватних забудовників Дніпра та області.
          </p>
        </div>
