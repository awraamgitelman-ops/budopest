...
export const Advantages = () => {
  const items = [
    ...
    },
    {
      ...
      title: "Щоденна доставка 06:00 — 22:00",
      desc: "Відвантаження без вихідних у дозволений час (з урахуванням комендантської години 00:00–05:00). Бази обладнані генераторами для безперебійної роботи під час знеструмлень."
    },
    {
