...
export const WAREHOUSES = [
  {
    id: 1,
    name: "Головна перевалка ТОВ «БЕНГС»",
    address: "м. Дніпро, вул. Чаплинська, 1А (Самарський р-н)",
    zone: "Самарський р-н / Чаплинка",
    ...
    mapQuery: "вулиця Чаплинська, 1А, Дніпро",
    googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=вулиця+Чаплинська,+1А,+Дніпро"
  },
  {
    id: 2,
