...
export const WAREHOUSES = [
  {
    ...
    address: "м. Дніпро, вул. Німецька, 283 (Самарський р-н)",
    zone: "Самарський р-н / Рибальське",
    ...
    mapQuery: "вулиця Німецька, 283, Дніпро",
    googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=вулиця+Німецька,+283,+Дніпро"
  },
  {
    id: 2,
