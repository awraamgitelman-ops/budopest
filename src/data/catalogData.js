...
export const MEGA_MENU_DATA = [
  {
    ...
    featured: true,
    items: [
      { id: "granitnyj", name: "Гранітний щебінь", price: "від 380 грн/т" },
      { id: "gravijnyj-shch", name: "Гравійний щебінь", price: "від 360 грн/т" },
      { id: "domennyj", name: "Шлаковий щебінь (доменний)", price: "від 240 грн/т" },
      { id: "izvestnyakovyj", name: "Вапняковий щебінь", price: "від 320 грн/т" },
      { id: "ballastnyj", name: "Баластний щебінь", price: "від 390 грн/т" },
      { id: "butovyj", name: "Бутовий камінь (бут)", price: "від 450 грн/т" },
      { id: "vtorichnyj", name: "Вторинний щебінь (дробл. бетон)", price: "від 190 грн/т" },
      { id: "gabbro-diabaz", name: "Габро-діабаз", price: "від 480 грн/т" },
      { id: "dolomitovyj", name: "Доломітовий щебінь", price: "від 340 грн/т" },
      { id: "mytyj", name: "Митий щебінь", price: "від 420 грн/т" },
      { id: "shlakovyj-otval", name: "Шлаковий щебінь (відвальний)", price: "від 240 грн/т" },
      { id: "gabiony", name: "Щебінь для габіонів", price: "від 520 грн/т" },
      { id: "v-meshkah", name: "Щебінь у мішках (25/50 кг)", price: "від 65 грн/мішок" },
      { id: "bigbeg", name: "Щебінь у Біг-бегах (1 т)", price: "від 650 грн/т" },
      { id: "mramornyj", name: "Мармуровий щебінь (біла крихта)", price: "від 1 200 грн/т" }
    ]
  },
  {
    id: "grunty",
    ...
    link: "#catalog-items",
    items: [
      { id: "grunt-chernozem", name: "Чорнозем польовий родючий", price: "від 350 грн/т" },
      { id: "grunt-rastitelnyj", name: "Почвоґрунт рослинний", price: "від 320 грн/т" },
      { id: "grunt-torf", name: "Торфо-піщана суміш", price: "від 420 грн/т" },
      { id: "grunt-planir", name: "Планувальний ґрунт (суглинок)", price: "від 180 грн/т" },
      { id: "grunt-bigbeg", name: "Ґрунт у Біг-бегах (1 т)", price: "від 750 грн/т" }
    ]
  },
  {
    id: "pesok",
    ...
    link: "#catalog-items",
    items: [
      { id: "pesok-rechnoj", name: "Річковий пісок (Дніпро, митий)", price: "від 280 грн/т" },
      { id: "pesok-karyernyj", name: "Кар'єрний пісок (яружний)", price: "від 220 грн/т" },
      { id: "pesok-seyanyj", name: "Сіяний пісок (модуль 1.8-2.2)", price: "від 260 грн/т" },
      { id: "pesok-grunt", name: "Піскоґрунт на підсипку", price: "від 160 грн/т" },
      { id: "pesok-meshki", name: "Пісок у мішках по 50 кг", price: "від 65 грн/мішок" }
    ]
  },
  {
    id: "shps",
    ...
    link: "#catalog-items",
    items: [
      { id: "shps-c5", name: "ЩПС С5 (0-40 мм)", price: "від 340 грн/т" },
      { id: "shps-c7", name: "ЩПС С7 (0-20 мм)", price: "від 350 грн/т" },
      { id: "shps-c4", name: "ЩПС С4 (0-70 мм)", price: "від 330 грн/т" }
    ]
  },
  {
    id: "pgs",
    ...
    link: "#catalog-items",
    items: [
      { id: "pgs-prirod", name: "ПГС природна піщано-гравійна", price: "від 290 грн/т" },
      { id: "opgs-obog", name: "ОПГС збагачена (гравій 50-70%)", price: "від 360 грн/т" }
    ]
  },
  {
    id: "gravij",
    ...
    link: "#catalog-items",
    items: [
      { id: "gravij-5-20", name: "Гравій природний 5-20 мм", price: "від 360 грн/т" },
      { id: "gravij-20-40", name: "Гравій природний 20-40 мм", price: "від 350 грн/т" },
      { id: "gravij-40-70", name: "Гравій крупний 40-70 мм", price: "від 340 грн/т" }
    ]
  },
  {
    id: "keramzit",
    ...
    link: "#catalog-items",
    items: [
      { id: "keramzit-5-10", name: "Керамзитовий гравій 5-10 мм", price: "від 1 650 грн/м³" },
      { id: "keramzit-10-20", name: "Керамзитовий гравій 10-20 мм", price: "від 1 550 грн/м³" },
      { id: "keramzit-20-40", name: "Керамзитовий гравій 20-40 мм", price: "від 1 450 грн/м³" },
      { id: "keramzit-meshki", name: "Керамзит у мішках (50 л)", price: "від 95 грн/мішок" }
    ]
  },
  {
    id: "galka",
    ...
    link: "#catalog-items",
    items: [
      { id: "galka-rechnaya", name: "Річкова галька (Дніпровська)", price: "від 550 грн/т" },
      { id: "galka-morskaya", name: "Морська окатана галька", price: "від 850 грн/т" },
      { id: "kamin-dekor", name: "Декоративний камінь", price: "від 700 грн/т" }
    ]
  }
];
...
export const ALL_PRODUCTS = [
  ...
  },
  {
    ...
    flakiness: "просіяний",
    density: "1.25 т/м3",
    image: "/images/img_pochvohrunt.jpg",
    description: "Збагачений просіяний почвоґрунт (суміш чорнозему, торфу та піску) з нейтральним pH для посадки кущів, дерев, влаштування газонів та вирівнювання ландшафту."
  },
  {
    id: "grunt-torf",
    sectionId: "grunty",
  ...
  },
  {
    ...
    flakiness: "до 12%",
    density: "1.52 т/м3",
    image: "/images/img_shchs_0_20.png",
    description: "Дрібнозерниста щебенево-піщана суміш фракції 0-20 мм (С7) для заклинки, планування доріг, укладання тротуарної плитки та створення щільної основи."
  },
  {
    id: "shps-c4",
    sectionId: "shps",
  ...
  },
  {
    ...
    flakiness: "крупний",
    density: "1.38 т/м3",
    image: "/images/img_hraviy_40_70.png",
    description: "Крупний колотий та окатаний гравій фракції 40-70 мм для дренажу септиків, влаштування подушок під під'їзні шляхи, габіонів та укріплення схилів."
  },
  ...
  },
  {
    ...
    strength: "М1000",
    frost: "F200",
    flakiness: "окатана крапчаста",
    density: "1.42 т/м3",
    image: "/images/img_morska_halka.png",
    description: "Натуральна морська окатана галька сіро-плямистої гранітної текстури для облицювання фонтанів, альпінаріїв, інтер'єрного декору та мозаїчних садових доріжок."
  },
  {
    id: "kamen-dekor",
    sectionId: "galka",
...
export const WAREHOUSES = [
  {
    ...
    address: "м. Дніпро, вул. Журналістів, 3 (Індустріальний р-н)",
    zone: "Лівий берег / Головний офіс",
