      ...
      <div className="calc-hero">
        <div className="container">
          ...
          <p className="calc-hero-subtitle">
            Точний інженерний розрахунок кубатури, маси в тоннах з урахуванням коефіцієнта ущільнення $K_{ущ}$ та автоматичним розрахунком вартості доставки самоскидами по районах Дніпра.
          </p>
        </div>
      </div>
            ...
            <table className="custom-table">
              <thead>
                <tr>
                  ...
                  <th>Коефіцієнт ущільнення ($K_{ущ}$)</th>
