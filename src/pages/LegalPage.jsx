                ...
                <div className="legal-info-card">
                  ...
                  <div className="legal-data-list">
                    ...
                    <div className="data-row">
                      ...
                      <strong className="data-val">Україна, 49051, м. Дніпро, вул. Німецька, 283</strong>
                    </div>
                    <div className="data-row">
          ...
          {activeTab === 'offer' && (
            <div className="legal-section">
              ...
              <div className="legal-document-text">
                ...
                <p>4.1. Доставка здійснюється самоскидами 10, 15, 25, 30, 40 тонн або самовивозом з перевалки м. Дніпро, вул. Німецька, 283.</p>
