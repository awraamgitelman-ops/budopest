      ...
      <div className="container py-12">
        ...
        <div className="about-story-grid">
          <div className="as-text">
            ...
            <p>
              Ми оперуємо 4 перевалочними базами у ключових логістичних вузлах Дніпра (вул. Чаплинська, 1А, Правий берег — Набережна Заводська, Любимівський кар'єр, Кам'янський термінал).
            </p>
