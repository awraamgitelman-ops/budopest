      ...
      <div className="container py-12">
        ...
        <div className="about-story-grid">
          <div className="as-text">
            ...
            <p>
              Компанія ТОВ «БЕНГС» забезпечує будівельні компанії, дорожніх підрядників, виробників бетону та приватних забудовників нерудними матеріалами гарантованої якості безпосередньо з кар'єрів та перевалочних терміналів.
            </p>
            <p>
              Ми оперуємо 4 перевалочними базами у ключових логістичних вузлах Дніпра (Самарський р-н — вул. Німецька, 283, Правий берег — Набережна Заводська, Любимівський кар'єр, Кам'янський термінал).
            </p>
